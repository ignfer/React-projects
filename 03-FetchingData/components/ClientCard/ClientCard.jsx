...
export default function ClientCard({clients, setSelectedClient, selectedAdvisor}){
  if(selectedAdvisor.AccountStatus === 'Enabled'){
    return(
      clients.map((client) => (
    ...
    return(<h3>Sorry, this account is disabled, please contact your administrator to change it.</h3>);
  }
}
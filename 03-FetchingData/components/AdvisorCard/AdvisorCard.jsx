...
function AdvisorCard({advisors, setSelectedAdvisor, setSelectedClient}){
  
  const handleClick = (advisor) => {
  ...
  return(
    <>
      {advisors.map((advisor) => (
        <div className='advisorCard' key={advisor.AccountNumber} onClick={() => handleClick(advisor)}>
